use super::{fun_stream::{Expand, FunStream}, stream_defs::{IntoStreamIterator, IndexedStream}};
...
impl<L, R> StreamMul<R> for L
    where L: IndexedStream,
          R: IndexedStream<I=L::I>,
          L::V: StreamMul<R::V> {
...
impl<L, R> IndexedStream for MulFunStream<L, R>
    where L: IndexedStream,
          R: FunStream<I=L::I>,
          L::V: StreamMul<R::V> {
    type I = L::I;
...
impl<I, L, R> IndexedStream for MulStream<L, R> 
